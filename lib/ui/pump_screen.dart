...
import 'widgets/pump_mirror_panel.dart';
            ...
            child: snap == null
                ...
                : ListView(
                    ...
                    children: [
                      ...
                      // Issue #84: what the pump is showing on its own screen.
                      // Renders nothing unless the pump actually answered op 57.
                      PumpMirrorPanel(snapshot: snap),
